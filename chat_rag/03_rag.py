...
from langchain_ollama import ChatOllama  # still using mistral for answering
from langchain_community.embeddings import HuggingFaceEmbeddings  # ✅ HF embeddings

# Initialize LLM (Ollama mistral for answering)
...
# This will download the model if not cached yet
